...
df_report = df_calcs.join(df_cliente_agg, "cod_cliente", "left") \
    ...
    .select(
        ...
        round(col("prazo_medio_operacao"), 0).cast("int").alias("prazo_medio_operacao"),
        round(col("prazo_medio_prorrogado_op"), 0).cast("int").alias("prazo_medio_prorrogado_op"),
        ...
        round(col("prazo_medio_ponderado_cliente"), 0).cast("int").alias("prazo_medio_ponderado_cliente"),
        round(col("prazo_medio_atraso_titulos_mora"), 0).cast("int").alias("prazo_medio_atraso_titulos_mora"),
