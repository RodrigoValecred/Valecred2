...
def process_operacoes_stream(df_ops, df_titulos):
    ...
    df_stream_ops = df_ops_enrich \
        ...
        .groupBy("mes_ref", "cod_cliente", "cod_operacao", "nbordero", "chave_produto", "nome_plataforma", "data_deferimento", "floating") \
        .agg(
...
# Enriquecer com Gestor
df_union = df_union.join(df_clientes.select("cod_cliente", "nome_gerente"), "cod_cliente", "left")
