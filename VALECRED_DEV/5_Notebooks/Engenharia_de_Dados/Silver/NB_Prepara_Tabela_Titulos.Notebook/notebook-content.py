...
if is_incremental_possible:
    ...
    # Proteção contra tabela vazia ou nulos. Usando first() em vez de collect()
    # para evitar materializar a lista completa no driver e melhorar o tempo de resposta.
