...
# 1. Verificar Dados na Origem (Bronze - Eventos de Cobrança)
...
# 2. Verificar Tabela de Títulos (Silver)
...
# 3. Verificar Tabela Final (Relatório Jurídico)
...
# 4. Análise de Discrepância (Órfãos)
print("\n4. Analisando Discrepâncias (Eventos na Bronze sem Título na Silver)...")
if 'df_juridico_events' in locals() and 'df_titulos' in locals():
