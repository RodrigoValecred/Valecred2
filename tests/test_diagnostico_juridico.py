...
class TestDiagnosticoJuridico(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def create_mock_col(name):
            ...
            # Portanto, alias também deve retornar um mock (ou uma string se os mocks de agg aceitarem strings)
            # Vamos retornar uma string para simplificar a depuração, mas, como agg é um mock, não importa o que ele retorna, desde que retorne *alguma coisa*.
    ...
    def test_check_silver_titulos_success(self):
        ...
        # Precisamos que agg(...) retorne um DataFrame, e collect() retorne uma lista de Rows
