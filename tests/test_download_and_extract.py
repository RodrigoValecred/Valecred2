...
# Garante que o diretório de testes está no path
...
class TestDownloadAndExtract(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Cria uma fixture de arquivo zip malicioso
        ...
        # Cria uma fixture de arquivo zip seguro
        ...
        # Carrega o safe_extract
        exec(self.safe_extract_source, self.exec_globals)
        # Carrega o download_and_extract
    ...
    def test_successful_download_first_mirror(self):
        # Configura os mocks para simular o download do zip seguro
    ...
    def test_fallback_to_second_mirror(self):
        # O primeiro mirror falha na requisição head, o segundo tem sucesso
    ...
    def test_zip_slip_vulnerability(self):
        ...
        # Nota: `safe_extract` lança a Exception("Zip Slip vulnerability detected").
        # A função `download_and_extract` a captura e lança um RuntimeError
        ...
        # Verifica se o arquivo malicioso NÃO foi extraído para fora
