...
def test_generate_markdown_empty_inputs():
    ...
    # Deve conter o cabeçalho e títulos de seção, mas sem ativos
    ...
    # Não deve conter nenhum markdown de ativo como "### "
    assert "### " not in md
...
def test_generate_markdown_missing_inventory_lakehouse():
    ...
    assert "- **Description:** (Missing description)" in md
    # Certificar que não possui linhas específicas de Notebook/Dataflow
