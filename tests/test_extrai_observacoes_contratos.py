...
class TestConverterMoedaBr(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        if func_source:
            # Cria um contexto com funções mock para serem usadas como globais durante a execução da função
            context = {
                "col": mock_col,
    ...
    def test_converter_moeda_br_structure(self):
        ...
        # A lógica da função:
        # 1. regexp_replace(col(col_name), "\.", "")  -> remove separador de milhares
