...
class TestVOPMetrics(unittest.TestCase):
    ...
    def test_calculate_vop_metrics_edge_cases(self):
        ...
        data = [
            ...
            Row(cod_cliente=1, dia_da_semana_da_operacao=3, dia_da_operacao=15, valor_de_face=200.0), # semana máx 3, mês máx 15

            # Cliente 2: Várias entradas para o mesmo dia devem ser agregadas
            ...
            Row(cod_cliente=2, dia_da_semana_da_operacao=5, dia_da_operacao=21, valor_de_face=60.0), # semana máx 4 (100 > 60)
